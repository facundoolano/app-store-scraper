...
import { request, storeId, lookup } from './common.js';
...
function list (opts) {
  return new Promise(function (resolve, reject) {
    ...
    const url = `http://ax.itunes.apple.com/WebObjects/MZStoreServices.woa/ws/RSS/${opts.collection}/${category}/limit=${opts.num}/json?s=${storeIdentifier}`;
